...
<td>
<p>Nationality of Means of Transport Crossing Border is to enter a 'Country Code' if transport mode at border is one of the following:</p>
<ul>
<li>3 - Road</li>
<li>10 - (NEW) RoRo &ndash; accompanied</li>
<li>11 - (NEW) RoRo &ndash; unaccompanied</li>
...
<ul>
<li>if provided it must contain the language code (of the language used) in the corresponding free text field<br /><br /></li>
</ul>
</td>
</tr>
<tr>
...
<p>Consignee EORI</p>
<ul>
<li>If the consignee has a GB EORI, this information is optional. If the consignee has an EU EORI, this information is mandatory</li>
</ul>
</td>
</tr>
<tr>
...
<td>---Goods Item</td>
<td>GOOITEGDS</td>
<td>This section is for the good items which are being sent</td>
</tr>
<tr>
<td>Item Number</td>
<td>IteNumGDS7</td>
...
<p>Place of Unloading must be provided when the message is encoded in EDIFACT and the corresponding free text field is not in the UNOC character set:</p>
<ul>
<li>if provided it must contain the language code (of the language used) in the corresponding free text field</li>
</ul>
</td>
</tr>
<tr>
...
<ul>
<li>optional if 'Kind of packages' indicates 'bulk' or 'Unpacked', or if the 'specific circumstance indicator' has been used</li>
</ul>
</td>
</tr>
<tr>
...
<td>Entry Carrier Postal Code</td>
</tr>
<tr>
<td>City</td>
