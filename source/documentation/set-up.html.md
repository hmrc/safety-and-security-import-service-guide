...
Community System Provider’s (CSP) may register privileged applications with HMRC, which is in line with the practice previously used for the Customs Declaration Service (CDS).
