...
This repository contains the source files that are used to generate the [Safety and Security Import Declarations Service Guide on the HMRC Developer Hub](https://developer.service.hmrc.gov.uk/guides/safety-and-security-import-declarations-end-to-end-service-guide).
